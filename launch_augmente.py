...
for year in range(2025, current_year + 1):
    for month in range(1, 13):
        ...
        new_filenames = [
            f"{new_date_prefix}-marche-2022.csv",
            f"{new_date_prefix}-marche-exclu-2022.csv",
            f"{new_date_prefix}-concession-2022.csv",
            f"{new_date_prefix}-concession-exclu-2022.csv"
        ]
