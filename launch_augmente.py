...
date_prefix = '2025-10-14'

RESULT_PATH = "/mnt/c/projets/decp-rama/results/REF"
...
for year in range(2024, current_year + 1):
    for month in range(1, 13):
        ...
        source_file = f"{RESULT_PATH}/decp-{new_date_prefix}.json"  # Remplacez par le chemin correct
